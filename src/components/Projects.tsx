...
function Card({ project, threshold }: { project: any, threshold: number }) {
    ...
    return (
        <div
            ref={ref}
            className={`relative group w-full max-w-[30rem] h-auto transition-transform duration-1000 ease-out transform 
            ${isVisible ? 'translate-x-0' : '-translate-x-20'
                }`}
        >
            <CardContainer
                className="inter-var sm:h-auto"
            >
